...
log = logging.getLogger("shared.telegram.host.wire")
...
def include_knowledge_ingest(dp: Dispatcher) -> None:
    ...
    from shared.telegram.host.constants import DOMAIN_KNOWLEDGE, UI_MODE_AUTO
    from shared.telegram.host.knowledge_dispatch import handle_knowledge_media
...
def include_host_voice(dp: Dispatcher) -> None:
    ...
    from shared.telegram.host.constants import DOMAIN_FINANCE, UI_MODE_AUTO
