...
def export_shell_env() -> str:
    ...
    lines = [
        ...
        f"export VAULT_FILE_CHART_COMPLETIONS_PNG={_sh_quote(vault_file('chart_completions_by_category_png'))}",
        f"export VAULT_FILE_CHART_OPEN_PIPELINE_PNG={_sh_quote(vault_file('chart_open_pipeline_png'))}",
        f"export VAULT_FILE_CHART_DEADLINE_PNG={_sh_quote(vault_file('chart_deadline_horizon_png'))}",
        ...
        f"export VAULT_FILE_CHART_HEALTH_TRENDS_PNG={_sh_quote(vault_file('chart_health_trends_png'))}",
        f"export VAULT_FILE_CHART_CROSS_CORR_PNG={_sh_quote(vault_file('chart_cross_correlations_png'))}",
        f"export VAULT_FILE_HEALTH_DASHBOARD={_sh_quote(vault_file('health_dashboard_md'))}",
        f"export VAULT_FILE_FINANCE_DASHBOARD={_sh_quote(finance_sub('dashboard_md'))}",
        f"export VAULT_FILE_CALENDAR_DASHBOARD={_sh_quote(vault_file('calendar_dashboard_md'))}",
        f"export VAULT_FILE_ANALYTICS_DASHBOARD={_sh_quote(vault_file('analytics_dashboard_md'))}",
        f"export VAULT_FILE_ROUTINES_CALENDAR_SUBDIR={_sh_quote(vault_file('routines_calendar_subdir'))}",
        f"export VAULT_FILE_ROUTINES_STATS_MD={_sh_quote(vault_file('routines_stats_md'))}",
        f"export VAULT_FILE_ROUTINES_STATS_LEGACY_MD={_sh_quote(vault_file('routines_stats_legacy_md'))}",
