"""Legacy finance entrypoint — runs the unified host with a finance-first token."""
...
def _resolve_token() -> str:
    return (
        os.environ.get("TELEGRAM_FINANCE_BOT_TOKEN")
...
def main() -> None:
    ...
    asyncio.run(run_host_bot(token=token or None, token_env="TELEGRAM_FINANCE_BOT_TOKEN"))
