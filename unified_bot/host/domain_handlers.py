...
from unified_bot.host.menus import is_finance_menu, is_planning_menu

log = logging.getLogger("unified_bot.host.domain_handlers")
...
async def dispatch_knowledge(
    ...
    from unified_bot.host.knowledge_dispatch import try_handle_knowledge_text
